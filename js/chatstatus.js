$(document).ready(function () {
  ...
  var chatStatus = {},
    io_socket = null,
    opekaClientURL = 'https://cyberhus.dk',
    opekaBaseURL = 'https://demo.curachat.com',
    pairChatName = "The 1-to-1 chat",
    groupChatName = "The group chat",
    textStrings = {
      buttonAvailable: "Start chat",
      buttonOccupied: "Occupied",
      buttonClosed: "Closed",
      buttonError: "Error connecting.",
      statusFetching: "Connecting...",
      statusClosed_pair: pairChatName + ' is closed',
      statusClosed_group: groupChatName + ' is closed',
      statusError: "Error: no connection to server.",
      statusOccupied_pair: pairChatName + ' is occupied',
      statusOccupied_group: groupChatName + ' is occupied',
      statusAvailable_pair: pairChatName + ' is available',
      statusAvailable_group: groupChatName + ' is available',
    };
  ...
  function checkForUpdate() {
    $.getJSON('../assets/chatstatus.json', function (json) {
      chatStatus = json;
    });
    if (false) {
